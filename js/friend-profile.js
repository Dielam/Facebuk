...
(function rideScopeWrapper($) {
    ...
    function completeRequest(result) {
        ...
        if(result.User.UserStatus == 'FRIEND_REQUEST'){
            window.location.href = 'user_requested_profile.html?u=' + result.User.Item.Email;
        }
        ...
        var html = '<a href="/comments_friend.html?u=' + result.User.Item.Email + '" class="btn btn_menu btn_centered">Comentarios</a>';
        $("#comments_friend").append(html);
